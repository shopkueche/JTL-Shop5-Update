...
class Compare
{
     ...
     */
    private static $greekPrecendence = array(
        'pre-alpha',
        'alpha',
        'pre-beta',
        'beta',
    ...
    private static function greekLargerThan($greek1, $greek2)
    {
        ...
        return \array_search($greek1, self::$greekPrecendence) > \array_search($greek2, self::$greekPrecendence);
    }
}
